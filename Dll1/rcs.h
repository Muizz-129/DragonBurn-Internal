...
private:
    ...
    void compensation_sequence(uint16_t weapon_def_index, float sensitivity) {
        ...
        for (size_t i = 0; i < pattern->size(); ++i) {
            ...
            // Simpan indeks peluru sebenar: 0, 1, 2, 3...
            ...
            // Fasa Peluru 0: Jeda masa awal sahaja tanpa pergerakan tetikus
            ...
            // Fasa Peluru 1, 2, 3... : Mula tolak recoil
        ...
        // Reset semula ke 0 apabila pemain melepaskan butang Mouse 1
...
public:
    ...
    // Antara muka komunikasi dengan Aimbot
